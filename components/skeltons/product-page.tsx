...
const ProductSkelton = () => {
  return (
     <div className="w-full h-[90vh]  flex gap-6">
      {/* Big item skeleton */}
      <div className="bg-neutral-100 p-4 ml-12  w-[60%] rounded-lg shadow-md animate-pulse ">
        {/* Big item content */}
        <div className="w-full h-[50vh] bg-neutral-300 mb-4"></div>
        <div className="h-4 bg-neutral-200"></div>
      </div>
      <div className='bg-neutral-100 p-4 ml-12 flex flex-col gap-6 w-[60%] rounded-lg shadow-md animate-pulse '>
